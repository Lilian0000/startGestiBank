...
var FormInscriptionComponent = /** @class */ (function () {
    ...
    FormInscriptionComponent.prototype.onSubmit = function () {
        ...
        if (this.clientForm.valid) {
            var client = new Client_1.Client(this.id, this.clientForm.controls['firstName'].value, this.clientForm.controls['lastName'].value, this.clientForm.controls['email'].value, this.clientForm.controls['password'].value, this.clientForm.controls['address'].value, this.clientForm.controls['phonenumber'].value, null, 0);
